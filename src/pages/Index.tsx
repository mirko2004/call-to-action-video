    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="container mx-auto px-4 py-4 lg:py-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="lg:hidden mb-6 animate-slide-in-right">
            <div className="bg-gradient-to-br from-yellow-400/10 to-orange-400/10 border border-yellow-400/30 rounded-xl p-6">
              ...
              <p className="text-white/90 font-semibold mb-4">Scoprirai:</p>
              
              <div className="space-y-3 text-sm text-white/90">
                <div className="flex items-start space-x-2 animate-fade-in" style={{ animationDelay: '0.1s' }}>
                  <span className="text-green-400 mt-1">✅</span>
                  <span>Il Metodo che mi ha permesso di costruire un'entrata extra (fino a viverci)</span>
                </div>
                
                <div className="flex items-start space-x-2 animate-fade-in" style={{ animationDelay: '0.2s' }}>
                  <span className="text-green-400 mt-1">✅</span>
                ...
                <div className="flex items-start space-x-2 animate-fade-in" style={{ animationDelay: '0.3s' }}>
                  <span className="text-green-400 mt-1">✅</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="lg:col-span-1 hidden lg:block">
              <div className="bg-gradient-to-br from-yellow-400/10 to-orange-400/10 border border-yellow-400/30 rounded-xl p-6 sticky top-8 animate-fade-in">
                <h3 className="text-xl font-bold text-yellow-400 mb-4">
                  "Il Pentagono D'Oro per Trasformare la Tua Vita in un Viaggio Continuo"
                </h3>
